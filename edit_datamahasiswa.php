...
<body> 
    ...
    $id = $_GET['id']; 
    $data = mysqli_query($koneksi,"select * from tbmahasiswa where npm='$id'");     
    while($d = mysqli_fetch_array($data)){ 
        ...
        <form method="post" action="proses_update.php" enctype="multipart/form-data"> 
            <table> 
                ...
                <td>Jenis Kelamin</td> 
                <td> 
                    <input type="radio" name="jekel" value="L" <?php if($d['jns_kelamin']=='L') echo 'checked'?>>Laki-laki 
                    <input type="radio" name="jekel" value="P" <?php if($d['jns_kelamin']=='P') echo 'checked'?>>Perempuan 
            ...
            <tr> 
                ...
                <Select name=jurusan> 
                    ...
                    <option value="TI" <?php if($d['jurusan']=="TI") echo 'selected="selected"'; ?> >TI</option>                     <option value="SIA" <?php if($d['jurusan']=="SIA") echo 'selected="selected"'; ?> >SIA</option> 
                </select> 
                </td> 
            </tr> 
            <tr> 
                <td>Kelas</td> 
                <td>
                    <input type="text" name="kelas" value="<?php echo $d['kelas']; ?>"></td> 
            </tr> 
            <tr> 
                <td>Photo</td> 
                <td>
